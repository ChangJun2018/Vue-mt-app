<template>
  <div class="goods">
      ...
      <div class="menu-wrapper" ref="menuScroll">
        <ul>
          <!-- 专场 -->
          <li class="menu-item" @click="selectMenu(0)" :class="{'current':currentIndex===0}">
            <p class="text">
          ...
          <li class="menu-item" @click="selectMenu(index+1)" :class="{'current':currentIndex===index+1}" v-for="(item,index) in goods" :key="index">
            <p class="text">
          ...
          <ul>
            <li 
              ...
              <div class="cartcontrol-wrapper">
                <app-cartcontral :food="food"></app-cartcontral>
              </div>
            </li>
          </ul>
        </li>
...
import CartContral from '../cartcontrol/CartContral'
import ProductDetail from '../productDetail/ProductDetail'
export default{
  components: {
    "app-shopcart":Shopcart,
    "app-cartcontral":CartContral,
  ...
  methods: {
    ...
    initScroll(){
     ...
     selectMenu(index){
        ...
        //  滚动到相应的位置
        this.foodScroll.scrollToElement(element,800)
     },
    //  点击添加食物分类列表上有相应的数量提示
    // 返回添加购物车食物数量
     calculateCount(spus){
